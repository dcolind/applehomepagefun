...
function Nav() {
  return (
    <div className="nav-color text-white h-14 flex flex-row space-x-14 mx-auto ">
        <AppleIcon className=' navh-7 mt-3 text-gray-300 hover:text-white'/>
        ...
        <h1 className="mt-3 text-gray-300 hover:text-white cursor-pointer">Airtags </h1>
