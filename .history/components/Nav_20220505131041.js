...
function Nav() {
  return (
    <div className="nav-color text-white h-14 flex flex-row space-x-14">
        ...
        <h1 className="mt-3 text-gray-300 hover:text-white cursor-pointer">Support </h1>
        <SearchIcon className="mt-3 text-gray-300 hover:text-white cursor-pointer"/>
        <SearchIcon className=className="mt-3 text-gray-300 hover:text-white cursor-pointer"/>
    </div>
  )
}
