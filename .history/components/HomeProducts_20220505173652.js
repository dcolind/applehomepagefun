  ...
  return (
    <div>
        ...
        <div className='bg-black text-white'>
            ...
            <img loading='lazy' className='iPhon-image' src='https://i.guim.co.uk/img/media/a9ed586e7111048c8d4f0a85ce2ed7986da43eac/179_0_2537_1523/master/2537.jpg?width=445&quality=45&auto=format&fit=max&dpr=2&s=e8e474dc59b63dc8a7f53edd8862a3e4'></img>
        </div>
    </div>
  )
}
