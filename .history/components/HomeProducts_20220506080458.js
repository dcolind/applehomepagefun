  ...
  return (
    <div>
        ...
        <div  className='flex'>
            ...
            <img loading='lazy' className='grid-image' src="https://www.telstra.com.au/content/dam/tcom/lego/2021/plans-devices/accessories/header-desk-apple-watch-series-7-764x500-2x.jpg"></img>
        </div>
