  ...
  return (
    <div>
        ...
        <div className='flex' data-aos="fade-left">
            <img loading='lazy' onClick={() => router.push('airtag')} className='grid-image' src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MK0W3?wid=2000&hei=2000&fmt=jpeg&qlt=95&.v=1618028904000"></img>
            <img loading='lazy' className='grid-image' src="https://www.apple.com/newsroom/images/product/watch/standard/Apple_watch-experience-for-entire-family-hero_09152020_big.jpg.large.jpg"></img>
        </div>
